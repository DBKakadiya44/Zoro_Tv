...
public class RomanceAdapter extends RecyclerView.Adapter<RomanceAdapter.ViewHolder>
{
    ...
    public RomanceAdapter(HomeActivity homeActivity, ArrayList<MovieData> data) {
    ...
    @NonNull
    @Override
    public RomanceAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(homeActivity).inflate(R.layout.item_movie,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RomanceAdapter.ViewHolder holder, int position) {
...
//        holder.imageView.setImageResource(R.drawable.movie);
        ...
        holder.imageView.setOnClickListener(view -> {
            ...
            intent.putExtra("name","Romance Movie");
