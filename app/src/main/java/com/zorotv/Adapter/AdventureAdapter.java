...
public class AdventureAdapter extends RecyclerView.Adapter<AdventureAdapter.ViewHolder>
{
    ...
    public AdventureAdapter(HomeActivity homeActivity, ArrayList<MovieData> data) {
    ...
    @NonNull
    @Override
    public AdventureAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(homeActivity).inflate(R.layout.item_movie,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdventureAdapter.ViewHolder holder, int position) {
