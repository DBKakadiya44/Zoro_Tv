...
public class DramaAdapter extends RecyclerView.Adapter<DramaAdapter.ViewHolder>
{
    ...
    public DramaAdapter(HomeActivity homeActivity, ArrayList<MovieData> data) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DramaAdapter.ViewHolder holder, int position) {
        ...
        holder.imageView.setOnClickListener(view -> {
            ...
            AdmCommon.getInstance().loadOrShowAdmInterstial(false,homeActivity, new AdsCallBack() {
                ...
                public void onAdsClose() {
                    ...
                    intent.putExtra("name","Drama Movie");
