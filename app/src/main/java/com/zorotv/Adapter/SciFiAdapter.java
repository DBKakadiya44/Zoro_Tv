...
public class SciFiAdapter extends RecyclerView.Adapter<SciFiAdapter.ViewHolder>
{
    HomeActivity homeActivity;
    ArrayList<MovieData> data;
    public SciFiAdapter(HomeActivity homeActivity, ArrayList<MovieData> data) {
    ...
    @NonNull
    @Override
    public SciFiAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(homeActivity).inflate(R.layout.item_movie,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SciFiAdapter.ViewHolder holder, int position) {
...
//        holder.imageView.setImageResource(R.drawable.movie);
        ...
        holder.imageView.setOnClickListener(view -> {
            ...
            intent.putExtra("name","Sci-Fi Movie");
