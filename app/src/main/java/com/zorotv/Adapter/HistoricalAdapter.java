...
public class HistoricalAdapter extends RecyclerView.Adapter<HistoricalAdapter.ViewHolder>
{
    ...
    public HistoricalAdapter(HomeActivity homeActivity, ArrayList<MovieData> data) {
    ...
    @NonNull
    @Override
    public HistoricalAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(homeActivity).inflate(R.layout.item_movie,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HistoricalAdapter.ViewHolder holder, int position) {
        ...
        holder.imageView.setOnClickListener(view -> {
            ...
            AdmCommon.getInstance().loadOrShowAdmInterstial(false,homeActivity, new AdsCallBack() {
                ...
                public void onAdsClose() {
                    ...
                    intent.putExtra("name","Historical Movie");
